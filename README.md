...
*2025.09.06 Created a global registry of conversion categories for consistent handling of units across the app stored in conversions.py.  Updated fermentation.py to follow a similar style and structure to conversions.py.  Removed many redundant calls to normalise_unit().  Corrected priming().
